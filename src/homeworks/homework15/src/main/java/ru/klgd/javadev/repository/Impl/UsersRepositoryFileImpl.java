...
import ru.klgd.javadev.exception.UserNotFoundException;
import ru.klgd.javadev.model.User;
import ru.klgd.javadev.repository.UsersRepository;
...
public class UsersRepositoryFileImpl implements UsersRepository {
    ...
    private final static String FILENAME = "src/main/java/ru/klgd/javadev/input.txt";
